  ...
  .enrich_attr_by_lua(
    ...
    .enrich_attr_by_lua(
      ...
      export_item_attr=["good_quality", "level_reward", "level_reward_v2","ltr_alpha", "wtr_alpha", "ftr_alpha", "cmtr_alpha", 
                        "cmef_alpha", "ctr_alpha", "lvtr_alpha"],
      lua_script="""
        function calculate()
          local ltr_alpha = 1.0
...
send_to_mio_learner = DataReaderFlow(name = "send_to_mio_learner") \
  .send_to_mio_learner(
    attrs=labels+["level_reward", "level_reward_v2","good_quality","interact_weight", "interact_label", "long_view",
                  "time_weight", "forward_in_count", "forward_inside_weight",
                  "comment", "comment_effective_stay", "follow_weight", "comment_action_weight", "comment_copyward", "watch_comment_num",
                  'ltr_alpha', 'wtr_alpha', 'ftr_alpha', 'cmtr_alpha', 'cmef_alpha', 'ctr_alpha', 'lvtr_alpha',
                  'effective_view', 'long_view', 'like', 'forward', 'comment', 'follow',"click_comment_button"] + pxtr_list,
