...
read_data = DataReaderFlow(name="read_data") \
    .fetch_message(
        ...
        hdfs_path="viewfs:///home/reco_algorithm/dw/reco_algorithm.db/comment_model_data_wht/data_set=20241029_17_18_2h",
...
send_mio = DataReaderFlow(name="send_mio") \
    ...
    .send_to_mio_learner(
        attrs=labels + ['recall_type', 'comment_genre']+['comment_content_emb_v2', 'visual_comment_content_emb_vista'],
