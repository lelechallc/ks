...
expand_xtr = tf.stop_gradient(expand_xtr)
like_xtr = tf.stop_gradient(like_xtr)
reply_xtr= tf.stop_gradient(reply_xtr)
copy_xtr= tf.stop_gradient(copy_xtr)
share_xtr= tf.stop_gradient(share_xtr)
audience_xtr= tf.stop_gradient(audience_xtr)
continuous_expand_xtr= tf.stop_gradient(continuous_expand_xtr)
duration_predict= tf.stop_gradient(duration_predict)
duration_pos_bias_predict= tf.stop_gradient(duration_pos_bias_predict)
