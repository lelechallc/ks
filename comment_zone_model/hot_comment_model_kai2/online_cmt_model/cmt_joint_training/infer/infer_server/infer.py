...
infer_kess_name = "grpc_HotCommentXtrJointBertInfer"
...
model_btq_prefix = "cmt_rank_joint_bert"
...
class PredictServerFlow(LeafFlow, KuibaApiMixin, MioApiMixin, OfflineApiMixin, GsuApiMixin, UniPredictApiMixin, KgnnApiMixin, SeRecoApiMixin):
  ...
  def predict_with_mio_model(self, **kwargs):
    ...
    extra_inputs = [
      ("token_input_ids_double", "token_input_ids", 27),
      ("token_input_mask_double", "token_input_mask", 27),
      ("token_sep_ids_double", "token_sep_ids", 27)
    ]
    ...
    predict_subflow = PredictSubFlow(name="predict_sub_flow") \
      ...
      .fit_feature_into_double_list(
        common_attr_set = [],
        item_attr_set = ["token_input_ids", "token_input_mask", "token_sep_ids"],
        item_output_attr_set= ["token_input_ids_double", "token_input_mask_double", "token_sep_ids_double"],
      ) \
      .log_debug_info(
              item_attrs = ['comment_content','token_input_ids_double', 'token_input_mask_double', 'token_output', 'token_sep_ids_double'],
