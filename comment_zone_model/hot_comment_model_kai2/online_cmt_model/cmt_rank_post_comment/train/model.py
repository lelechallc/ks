...
comment_xtr = simple_dense_network("comment_after_read_xtr", input_wo_pos, [256, 128, 64, 1], 0.3, act=tf.nn.leaky_relu, last_act=tf.nn.sigmoid)
...
if args.mode == 'train' or args.mode == 'eval':
    ...
    targets = [
        ...
        ('comment_after_read_predict', comment_xtr),
    ]
