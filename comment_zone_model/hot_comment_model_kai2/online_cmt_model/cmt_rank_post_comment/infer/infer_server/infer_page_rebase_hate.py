...
# 请求带过来的attrs
item_attrs_from_req = [
  "like_cnt", "reply_cnt", "realshow_cnt", "author_id", "minute_diff", "dislike_cnt", "comment_genre", 'content_length',
]
...
service.build(output_file=os.path.join(current_folder, "infer_page_rebase_hate_config.json"))
