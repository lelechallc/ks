...
# 模型预估目标
PXTRS = ["expand_xtr", "like_xtr", "reply_xtr", "copy_xtr", "share_xtr", "audience_xtr", "continuous_expand_xtr", 'duration_predict', "hate_xtr", "report_xtr", 'depth_xtr', 'depth_interact_xtr']
...
model_btq_prefix = "cmt_context_depth"
...
# Infer服务最终返回的值
service.return_item_attrs(["expand_xtr", "like_xtr", "reply_xtr", "copy_xtr", "share_xtr", "audience_xtr", "continuous_expand_xtr", 'duration_predict', 'page_time_pxtr', "hate_xtr", "report_xtr", 'depth_xtr', 'depth_interact_xtr'])
