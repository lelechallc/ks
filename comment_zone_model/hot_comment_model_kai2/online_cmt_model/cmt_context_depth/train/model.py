...
depth_interact_xtr = simple_dense_network("depth_interact_xtr", input_wo_pos, [256, 128, 64, 1], 0.3, act=tf.nn.leaky_relu, last_act=tf.nn.sigmoid)
...
if args.mode == 'train' or args.mode == 'eval':
    ...
    depthInteract = kai.nn.get_dense_fea("depthInteract", dim=1, dtype=tf.float32)
    ...
    targets = [
        ...
        ('depth_interact_predict', depth_interact_xtr, ones, depthInteract * depthMask, "auc"),
        ('depth_interact_predict_neg', depth_interact_xtr, zeros, ones * depthMask, "auc"),
    ]
    ...
    eval_targets = [
        ...
        ('depth_predict', depth_xtr/(1-depth_xtr), depthAction, ones * depthMask, "auc"),
        # ('page_time_predict', page_time_xtr/(1-page_time_xtr), page_time_label, ones * depthMask, "linear_regression"),
        ('hate_predict', hate_xtr, hate_label, ones, "auc"),
        ('report_predict', report_xtr, report_label, ones, "auc"),
        ('depth_interact_predict', depth_interact_xtr/(1-depth_interact_xtr), depthInteract, ones * depthMask, "auc"),
    ]
    ...
    targets = [
        ...
        ("depth_xtr", depth_xtr/(1-depth_xtr)),
        ("depth_interact_xtr", depth_interact_xtr/(1-depth_interact_xtr)),
    ]
