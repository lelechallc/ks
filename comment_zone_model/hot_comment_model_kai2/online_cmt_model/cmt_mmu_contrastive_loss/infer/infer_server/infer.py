...
# 模型预估目标
PXTRS = ["expand_xtr", "like_xtr", "reply_xtr", "copy_xtr", "share_xtr", "audience_xtr", "continuous_expand_xtr", 'duration_predict', 'staytime_gauss_predict']
# 最终krp部署时会覆盖这个kess_name
infer_kess_name = "grpc_HotCommenMmuContrastiveInfer"
...
model_btq_prefix = "comment_contrastive_base"
...
colossusdb_embd_table_name="cmt-rank-mmu-contrastive-emb-table"
...
# Infer服务最终返回的值
service.return_item_attrs(["expand_xtr", "like_xtr", "reply_xtr", "copy_xtr", "share_xtr", "audience_xtr", "continuous_expand_xtr", 'duration_predict', 'staytime_gauss_predict'])
