...
# 模型预估目标
PXTRS = ["expand_xtr", "like_xtr", "reply_xtr", "copy_xtr", "share_xtr", "audience_xtr", "continuous_expand_xtr", 'duration_predict', 'hate_xtr']
# 最终krp部署时会覆盖这个kess_name
infer_kess_name = "grpc_HotCommentXtrJointBertInferCpu"
...
model_btq_prefix = "cmt_rank_bert_vv_gate"


embed_server_shards = 2
# krp 上 embedding_server的kess_name
embed_kess_name = "grpc_HotCommentXtrJointBertEmb"
    ...
    .extract_kuiba_parameter(
      ...
      .extract_kuiba_parameter(
        config={
            ...
            **discreate_config("realshow_cnt", 260, [100, 0, 10000, 1, 0]), # [0, 10000] 个桶，100 vv 一个桶
        },
...
# Infer服务最终返回的值
service.return_item_attrs(["expand_xtr", "like_xtr", "reply_xtr", "copy_xtr", "share_xtr", "audience_xtr", "continuous_expand_xtr", 'duration_predict', 'hate_xtr'])
