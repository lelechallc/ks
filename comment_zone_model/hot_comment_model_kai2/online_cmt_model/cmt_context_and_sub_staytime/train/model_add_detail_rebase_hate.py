...
click_detail_xtr = simple_dense_network("click_detail", input_wo_pos, [256, 128, 64, 1], 0.3, act=tf.nn.leaky_relu, last_act=tf.nn.sigmoid)
detail_time_xtr = simple_dense_network("detail_time_xtr", input_wo_pos, [256, 128, 64, 1], 0.3, act=tf.nn.leaky_relu, last_act=tf.nn.sigmoid)
...
if args.mode == 'train' or args.mode == 'eval':
    ...
    is_click_detail = kai.nn.get_dense_fea("is_click_detail", dim=1, dtype=tf.float32)
    detail_staytime_label = kai.nn.get_dense_fea("detail_stay_time", dim=1, dtype=tf.float32)
    ...
    targets = [
        ...
        ('click_detail_predict', click_detail_xtr, is_click_detail, ones, "auc"),
        ('detail_time_predict', detail_time_xtr, ones, is_click_detail * detail_staytime_label, "auc"),
        ('detail_time_predict_neg', detail_time_xtr, zeros, ones * is_click_detail, "auc"),
    ...
    eval_targets = [
        ...
        ('click_detail_predict', click_detail_xtr, is_click_detail, ones, "auc"),
        ('detail_time_predict', detail_time_xtr/(1-detail_time_xtr), detail_staytime_label, ones * is_click_detail, "linear_regression"),
        ('hate_predict', hate_xtr, hate_label, ones, "auc"),
        ('report_predict', report_xtr, report_label, ones, "auc"),
    ]
    ...
    targets = [
        ...
        ("staytime_gauss_predict", click_detail_xtr),
        ("detail_time_pxtr", detail_time_xtr/(1-detail_time_xtr)),
        ('hate_xtr', hate_xtr),
