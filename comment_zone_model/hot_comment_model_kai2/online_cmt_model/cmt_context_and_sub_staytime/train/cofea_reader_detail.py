...
item_attrs=["comment_id", "author_id", "like_cnt", "reply_cnt", "minute_diff", "realshow_cnt", "dislike_cnt",
            ...
            "comment_genre", 'content_length',"detailStayDurationMs_first", "detailStayDurationMs_second"
]
...
gen_feature = DataReaderFlow(name="gen_feature") \
    ...
    .enrich_attr_by_lua(
        import_item_attr=["detailStayDurationMs_first", "detailStayDurationMs_second"],
        function_for_item="gen_label",
        export_item_attr=["is_click_detail", "detail_stay_time"],
        lua_script=f"""
            function gen_label()
                local is_click_detail = 0
                local detail_stay_time = 0
                if detailStayDurationMs_first + detailStayDurationMs_second > 700 then
                    is_click_detail = 1
                    detail_stay_time = (detailStayDurationMs_first + detailStayDurationMs_second) / 1000
                end
                return is_click_detail, detail_stay_time
            end
        """
    ) \
    .enrich_attr_by_lua(
...
other_labels =["depthAction", "depthMask", "is_click_detail", "detail_stay_time"]
