...
PXTRS = ["expand_xtr", "like_xtr", "reply_xtr", "copy_xtr", "share_xtr", "audience_xtr", "continuous_expand_xtr", 
    'duration_predict', 'sub_staytime_predict', 'depth_xtr', 'page_time_pxtr','staytime_gauss_predict', 'detail_time_pxtr',
    'hate_xtr', 'report_xtr']
# 最终krp部署时会覆盖这个kess_name
infer_kess_name = "grpc_HotCommentSlideInfer"
...
# Infer服务最终返回的值
service.return_item_attrs(["expand_xtr", "like_xtr", "reply_xtr", "copy_xtr", "share_xtr", "audience_xtr", "continuous_expand_xtr", 'duration_predict', 'sub_staytime_predict', 'depth_xtr', 'page_time_pxtr','staytime_gauss_predict', 'detail_time_pxtr', "hate_xtr", "report_xtr"])
service.add_leaf_flows(leaf_flows = [comment_action_predict_flow], request_type="hot_comment_default")
service.build(output_file=os.path.join(current_folder, "infer_detail_config.json"))
