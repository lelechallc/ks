...
if args.mode == 'train' or args.mode == 'eval':
    ...
    comment_tag_embedding = kai.new_embedding("comment_tag_embedding", dim=32, slots=[253])
    ...
    interact_comment_tags_emb = config.new_embedding("interact_comment_tag_embedding", dim=8, expand=10, slots=[113], **compress_kwargs)
    # ------
