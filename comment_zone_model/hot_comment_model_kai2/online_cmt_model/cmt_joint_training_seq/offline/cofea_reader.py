...
read_data = DataReaderFlow(name="read_data") \
    .fetch_message(
        ...
        hdfs_path="viewfs:///home/reco_algorithm/dw/reco_algorithm.db/comment_model_data_wht/data_set=20250120_09_20_12h",
...
gen_feature = DataReaderFlow(name="gen_feature") \
    ...
    .extract_kuiba_parameter(
        config={
            ...
            **list_config("interact_comment_ids", 112, 201, 10),
            **list_config("comment_mmu_categories", 113, 253, 10),
    ...
    .extract_kuiba_parameter(
        config={
            ...
            **id_config("mmu_category_tag", 253),
    ...
    .log_debug_info(
            ...
            common_attrs=['interact_comment_ids'],
            for_debug_request_only=False,
            respect_sample_logging=True,
    ) \
...
send_mio = DataReaderFlow(name="send_mio") \
    ...
    .send_to_mio_learner(
        attrs=labels + ['recall_type', 'comment_genre', 'hate_label'] + ["token_input_ids", "token_input_mask", "token_sep_ids"],
