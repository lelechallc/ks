...
input_wo_pos = tf.concat([input_wo_pos, bert_output_emb], -1) # 最简单的联合方式：concat
...
effe_read_xtr = simple_dense_network("effe_read_xtr", input_wo_pos, [256, 128, 64, 1], 0.0, act=tf.nn.leaky_relu, last_act=tf.nn.sigmoid)
readtime_xtr = simple_dense_network("readtime_xtr", input_wo_pos, [256, 128, 64, 1], 0.0, act=tf.nn.leaky_relu, last_act=tf.nn.sigmoid)
