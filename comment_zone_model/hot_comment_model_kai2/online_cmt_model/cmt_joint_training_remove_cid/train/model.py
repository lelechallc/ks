...
if args.mode == 'train' or args.mode == 'eval':
    ...
    bert_output_emb =  kai.nn.new_embedding("bert_id_embedding", dim=256, slots=[252])
    ...
    bert_output_emb =  config.new_embedding("bert_id_embedding", dim=256, slots=[252])
...
# 去掉cid特征
input_wo_pos = tf.concat([user_embedding, comment_info_embedding, pid_embedding, aid_embedding, uid_embedding, did_embedding, context_embedding, comment_genre_embedding, comment_length_embedding], -1)
