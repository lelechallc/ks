...
class PredictServerFlow(LeafFlow, KuibaApiMixin, MioApiMixin, OfflineApiMixin, GsuApiMixin, UniPredictApiMixin, KgnnApiMixin, SeRecoApiMixin, EmbeddingApiMixin):
  ...
  def predict_with_mio_model(self, **kwargs):
    ...
    extra_inputs = [
      ...
      ("bert_first5_layers_emb_double", "bert_first5_layers_emb", 6912)
    ]
    class PredictSubFlow(LeafFlow, KuibaApiMixin, MioApiMixin, OfflineApiMixin, GsuApiMixin, UniPredictApiMixin, KgnnApiMixin, SeRecoApiMixin, EmbeddingApiMixin):
       pass
