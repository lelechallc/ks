...
infer_kess_name = "grpc_commentZoneListwisePositionDebiasInfer"
# 请求带过来的attrs
...
model_btq_prefix = "hot_comment_listwise_position"
embed_server_shards = 1
# krp 上 embedding_server的kess_name
embed_kess_name = "grpc_commentZoneListwisePositionDebiasEmb"
  ...
  def prepare(self):
    return self \
      ...
      .enrich_attr_by_lua(
        ...
        export_item_attr=["ltr", "rtr", "mask_pack", "position_id"],
  ...
  def predict_with_mio_model(self, **kwargs):
    ...
    return self.extract_kuiba_parameter(
      ...
      .log_debug_info(
          ...
          item_attrs=["expand_xtr", "like_xtr", "reply_xtr", "like_cnt", "reply_cnt", "realshow_cnt",
...
comment_action_predict_flow = PredictServerFlow(name="comment_zone_infer") \
  ...
  .perflog_attr_value(
      ...
      item_attrs=["expand_xtr", "like_xtr", "reply_xtr", "like_cnt", "reply_cnt", "realshow_cnt", "ltr", "rtr", "dislike_cnt", "minute_diff"],
  )
