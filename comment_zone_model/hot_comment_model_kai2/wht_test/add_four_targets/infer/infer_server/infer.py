...
infer_kess_name = "grpc_HotCommentXtrSevenTargetsInfer"

# 请求带过来的attrs
item_attrs_from_req = [
  "like_cnt", "reply_cnt", "realshow_cnt", "author_id", "minute_diff", "dislike_cnt", "quality_v2_score"
]
common_attrs_from_req = ["photo_id", "photo_author_id", 'age_segment', 'gender']
model_btq_prefix = "comment_model_add_4_targets"


embed_server_shards = 1
# krp 上 embedding_server的kess_name
embed_kess_name = "grpc_HotCommentXtrSevenTargetsEmb"
