...
if args.mode == 'train':
    ...
    subAtAction_first = tf.cast(kai.nn.get_dense_fea("subAtAction_first", dim=1, dtype=tf.int64), tf.float32)
    subAtAction_second = tf.cast(kai.nn.get_dense_fea("subAtAction_second", dim=1, dtype=tf.int64), tf.float32)
    sub_at_label = tf.where((subAtAction_first > 0) | (subAtAction_second > 0), ones, zeros)

    hateAction_first = tf.cast(kai.nn.get_dense_fea("hateAction_first", dim=1, dtype=tf.int64), tf.float32)
    hateAction_second = tf.cast(kai.nn.get_dense_fea("hateAction_second", dim=1, dtype=tf.int64), tf.float32)
    cancelHateAction_first = tf.cast(kai.nn.get_dense_fea("cancelHateAction_first", dim=1, dtype=tf.int64), tf.float32)
    cancelHateAction_second = tf.cast(kai.nn.get_dense_fea("cancelHateAction_second", dim=1, dtype=tf.int64), tf.float32)
    ...
    cancelLikeAction_first = tf.cast(kai.nn.get_dense_fea("cancelLikeAction_first", dim=1, dtype=tf.int64), tf.float32)
    cancelLikeAction_second = tf.cast(kai.nn.get_dense_fea("cancelLikeAction_second", dim=1, dtype=tf.int64), tf.float32)
    ...
    replyTaskAction_first = tf.cast(kai.nn.get_dense_fea("replyTaskAction_first", dim=1, dtype=tf.int64), tf.float32)
    replyTaskAction_second = tf.cast(kai.nn.get_dense_fea("replyTaskAction_second", dim=1, dtype=tf.int64), tf.float32)
