...
# infer_kess_name = "grpc_CommentAddTimeCityInfer"
infer_kess_name = "grpc_CommentAddContentInfer"
...
# model_btq_prefix = "comment_model_add_feat_label"
model_btq_prefix = "comment_model_add_mmu_emb"

embed_server_shards = 1
# krp 上 embedding_server的kess_name
# embed_kess_name = "grpc_CommentAddTimeCityEmb"
embed_kess_name = "grpc_CommentAddContentEmb"
  ...
  def predict_with_mio_model(self, **kwargs):
    ...
    return self.extract_kuiba_parameter(
        ...
        .log_debug_info(
            ...
            # common_attrs=['did_emb', 'photo_aid_emb', 'pid_emb', 'uid_emb', 'user_embedding'],
            # item_attrs=['a_id_embedding', 'c_id_embedding', 'c_info_embedding', 'comment_content_segs', 'final_seg_num', 'mask_pack', 'position_embedding', 'seq_pos_embedding'],
