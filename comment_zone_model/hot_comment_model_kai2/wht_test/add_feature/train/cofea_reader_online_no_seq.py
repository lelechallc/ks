...
common_attrs=["user_id", "device_id", "photo_id", "photo_author_id", "gender", "age_segment", "llsid", "mod",
              "page_type_str", "is_political", "product_name", 'city_name']
labels = [
...
set_default_value_str_attrs_for_common = ['device_id', 'llsid', 'mod', 'page_type_str', 'product_name', 'city_name']
...
gen_feature = DataReaderFlow(name="gen_feature") \
    ...
    .perflog_attr_value(
        check_point="wht_test.add_feature.train",
        ...
        common_attrs=['is_political', 'age_segment', 'mod', 'product_name', 'page_type_str', 'device_id', 'gender', 'photo_id',
                      "request_hour", 'request_day', 'final_seg_num'],
        aggregator="avg",
    ) \
    .perflog_attr_value(
        check_point="wht_test.add_feature.train",
...
send_mio = DataReaderFlow(name="send_mio") \
    ...
    .send_to_mio_learner(
        ...
        attrs=labels + ["realshow_cnt", "comment_genre", "recall_type", "sample_weight",
                        "comment_content_segs", "final_seg_num", "mask_pack"],
