"""
在v36基础上，去掉dcn和序列特征，底部为1024->512, tower为512->200->128->64->1
"""
import os
import argparse
...
if args.mode == 'train':
    ...
    context_emb = config.new_embedding("context_emb", dim=64, slots=[110, 111, 113])     # mod, page_type
...
expand_xtr, like_xtr, reply_xtr, copy_xtr, share_xtr, audience_xtr, continuous_expand_xtr = main_model(
    ...
    tower_units=[200, 128, 64, 1], explicit_cross_layer_num=None, explicit_cross_projection_dim=128,
    explicit_cross_final_proj_dim=256, implicit_cross_layer_units=[512], implicit_cross_enable_resnet=True,
