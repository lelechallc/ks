...
common_attrs=["user_id", "device_id", "photo_id", "photo_author_id", "gender", "age_segment", 
            #   "llsid",
            #   "mod", "client_request_info", "page_type_str", "is_political", "product_name", 
...
send_mio = DataReaderFlow(name="send_mio") \
    ...
    .send_to_mio_learner(
        attrs=labels + ['recall_type', 'sample_weight', 'comment_content_emb_v2', 'visual_comment_content_emb_vista'],
