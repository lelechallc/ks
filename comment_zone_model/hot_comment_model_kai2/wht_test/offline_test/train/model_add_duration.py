...
if args.mode == 'train' or args.mode == 'eval':
    ...
    pid_embedding = kai.nn.new_embedding("pid_embedding", dim=64, slots=[103], **compress_kwargs)
    aid_embedding = kai.nn.new_embedding("aid_embedding", dim=64, slots=[104], **compress_kwargs)
    uid_embedding = kai.nn.new_embedding("uid_embedding", dim=64, slots=[105], **compress_kwargs)
    did_embedding = kai.nn.new_embedding("did_embedding", dim=64, slots=[106], **compress_kwargs)
    context_embedding = kai.nn.new_embedding("context_embedding", dim=32, slots=[110, 111], **compress_kwargs)
