...
# def convert_timestamp_to_date(ctx: DragonflyContext) -> None:
#     request_time_ms = ctx.GetInt(b"request_time")
#     request_time_s = request_time_ms / 1000
#     dt = datetime.fromtimestamp(request_time_s)
#     hour = dt.hour
#     weekday = dt.weekday()

#     ctx.SetInt(b'request_hour', hour)       # 0-23 表示 00:00-23:59
#     ctx.SetInt(b'request_day', weekday)     # 0-6 表示周一到周日
...
runner.IGNORE_UNUSED_ATTR=['llsid'] + ['showAction','age_segment', 'audienceaction', 'device_id', 'expandaction', 'gender', 'is_political', 'likeaction', 'mod', 'page_type_str', 'photo_author_id', 'photo_id', 'predict_like_score', 'predict_reply_score', 'replyaction', 'reportaction', 'user_id']
