"""
个性化 model-v3 版本修改版：扩宽底层fcn（dim->512），同时增加残差连接
"""
import os
import argparse
...
expand_xtr, like_xtr, reply_xtr, copy_xtr, share_xtr, audience_xtr, continuous_expand_xtr = main_model(
    ...
    explicit_cross_final_proj_dim=None, implicit_cross_layer_units=[512, 512, 512], implicit_cross_enable_resnet=True,
