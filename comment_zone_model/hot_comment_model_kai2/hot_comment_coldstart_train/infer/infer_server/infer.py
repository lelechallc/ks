...
infer_kess_name = "grpc_commentZoneActionColdStartInfer"
# 请求带过来的attrs
item_attrs_from_req = [
  "author_id", "comment_genre", "risk_insult_tag", "risk_negative_tag", "risk_inactive_tag", "mmu_category_tag", "mmu_emotion_tag", "mmu_entity_list", "comment_content_segs"
]
common_attrs_from_req = []
model_btq_prefix = "comment_coldstart_model"
embed_server_shards = 1
# krp 上 embedding_server的kess_name
embed_kess_name = "grpc_commentZoneActionColdStartEmb"
...
comment_action_predict_flow = PredictServerFlow(name="comment_zone_infer_coldstart") \
  .prepare() \
...
service.add_leaf_flows(leaf_flows = [comment_action_predict_flow], request_type="comment_zone_action_coldstart")
