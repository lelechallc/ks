...
absent_position_input = tf.concat([user_embedding, comment_id_embedding, comment_info_embedding, comment_udp_id_embedding], -1)
...
slide_xtr = simple_dense_network("slide_xtr", absent_position_input, [256, 128, 64, 1], 0.0, act=tf.nn.leaky_relu, last_act=tf.nn.sigmoid)
...
if args.mode == 'train':
    ...
    targets = [
        ...
        ('slide_predict', slide_xtr, slide_copy_label, ones, "auc"),
    ]
