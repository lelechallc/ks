...
infer_kess_name = "grpc_commentZoneEnhanceInfer"
# 请求带过来的attrs
item_attrs_from_req = [
  "like_cnt", "reply_cnt", "realshow_cnt", "author_id", "minute_diff", "dislike_cnt",
  'comment_genre', 'mmu_category_tag', 'mmu_emotion_tag', 'mmu_entity_list', 'risk_inactive_tag', 'risk_insult_tag', 'risk_negative_tag'
]
common_attrs_from_req = ["photo_id", "photo_author_id"]
model_btq_prefix = "hot_comment_text"
embed_server_shards = 1
# krp 上 embedding_server的kess_name
embed_kess_name = "grpc_commentZoneEnhanceEmb"
